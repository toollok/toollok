...
export default function Testimonials() {
     return (
          <section className="max-w-7xl mx-auto px-4 py-20 border-t border-gray-800/40">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {TESTIMONIALS.map((testimonial) => (
                         <div
                              key={testimonial.id}
                              className="bg-gray-900/40 border border-gray-800 rounded-3xl p-8 relative flex flex-col justify-between hover:bg-gray-900/80 transition-colors"
                         >
                              <Quote size={40} className="text-gray-800 absolute top-6 right-6 opacity-50" />
                              ...
                              <div className="flex items-center gap-4 border-t border-gray-800/60 pt-4">
