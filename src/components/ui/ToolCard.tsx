...
export default function ToolCard({ tool }: { tool: Tool }) {
     ...
     return (
          <Link
               href={tool.slug}
               className="group relative bg-white dark:bg-gray-900/40 hover:bg-gray-50 dark:hover:bg-gray-800/60 border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700/80 rounded-2xl p-6 transition-all duration-300 flex flex-col justify-between backdrop-blur-md shadow-lg hover:shadow-2xl hover:-translate-y-1"
          >
               <div>
                    {/* Header Badge Row */}
                    <div className="flex items-center justify-between mb-4">
                         <div className="w-12 h-12 bg-gray-100 dark:bg-gray-800/80 group-hover:bg-blue-50 dark:group-hover:bg-blue-600/10 border border-gray-200 dark:border-gray-700/50 group-hover:border-blue-200 dark:group-hover:border-blue-500/30 rounded-xl flex items-center justify-center text-gray-600 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
               ...
               {/* Footer Link Action */}
               <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-800/60 text-xs font-semibold text-gray-500 dark:text-gray-500 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
