               ...
               <div className="w-full max-w-3xl mx-auto flex flex-col gap-6">
                    ...
                    <div className="bg-gray-900 border border-gray-800 rounded-3xl p-8 md:p-12 flex flex-col gap-6 shadow-xl">
                         ...
                         <div className="flex flex-col gap-4 text-xs md:text-sm text-gray-300 leading-relaxed">
                              <h2 className="text-white font-bold text-base mt-2">1. Acceptance of Terms</h2>
                              ...
                              <h2 className="text-white font-bold text-base mt-2">2. Free Utility Use</h2>
                              ...
                              <h2 className="text-white font-bold text-base mt-2">3. Intellectual Property</h2>
