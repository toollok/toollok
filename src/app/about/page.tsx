     ...
     return (
          <main className="min-h-screen bg-white dark:bg-[#090d16] text-gray-900 dark:text-white flex flex-col items-center px-4 py-12 transition-colors">
               <div className="w-full max-w-4xl mx-auto flex flex-col gap-8">
                    ...
                    {/* Hero Section */}
                    <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-8 md:p-12 flex flex-col items-center text-center gap-6 shadow-xl relative overflow-hidden">
                         ...
                         <div>
                              <h1 className="text-3xl md:text-5xl font-black text-gray-900 dark:text-white mb-4">Empowering Builders.</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                         <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-8 flex flex-col gap-4 shadow-md">
                         ...
                         <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-8 flex flex-col gap-4 shadow-md">
                              <div className="w-10 h-10 bg-amber-50 dark:bg-amber-500/10 rounded-xl flex items-center justify-center text-amber-500 dark:text-amber-400 border border-amber-100 dark:border-amber-500/20">
                                   <Zap size={20} />
                              </div>
                         ...
                         <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-8 flex flex-col gap-4 shadow-md">
                              ...
                              <h3 className="text-lg font-bold text-gray-900 dark:text-white">100% Free</h3>
                              <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
