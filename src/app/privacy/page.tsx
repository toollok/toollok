               ...
               <div className="w-full max-w-3xl mx-auto flex flex-col gap-6">
                    ...
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-8 md:p-12 flex flex-col gap-6 shadow-sm dark:shadow-xl transition-colors">
                         <div className="flex items-center gap-3">
                              ...
                              <div>
                                   <h1 className="text-2xl md:text-3xl font-black text-gray-900 dark:text-white">Privacy Policy</h1>
                         ...
                         <div className="flex flex-col gap-4 text-xs md:text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                              <h2 className="text-gray-900 dark:text-white font-bold text-base mt-2">1. Information We Collect</h2>
                              ...
                              <h2 className="text-gray-900 dark:text-white font-bold text-base mt-2">2. Cookies and Advertising</h2>
                              ...
                              <h2 className="text-gray-900 dark:text-white font-bold text-base mt-2">3. Third-Party Links</h2>
                              ...
                              <h2 className="text-gray-900 dark:text-white font-bold text-base mt-2">4. Contact</h2>
