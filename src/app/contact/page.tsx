               ...
               <div className="w-full max-w-3xl mx-auto flex flex-col gap-6">
                    ...
                    <div className="bg-gray-900 border border-gray-800 rounded-3xl p-8 md:p-12 flex flex-col gap-6 shadow-xl">
                         <div className="flex items-center gap-3">
                              ...
                              <div>
                                   <h1 className="text-2xl md:text-3xl font-black text-white">Contact Us</h1>
                                   <p className="text-sm text-gray-400">We would love to hear your feedback or tool requests.</p>
                              </div>
                         </div>
                         ...
                         <div className="flex flex-col gap-4 text-sm text-gray-300 leading-relaxed">
                              ...
                              <div className="bg-gray-950 border border-gray-800 rounded-2xl p-6 flex items-center gap-4">
                                   ...
                                   <div>
                                        ...
                                        <a href="mailto:support@toollok.com" className="text-blue-400 font-bold hover:underline">support@toollok.com</a>
                                   </div>
                              </div>
