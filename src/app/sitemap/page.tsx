          ...
          <main className="min-h-screen bg-[#090d16] text-white flex flex-col items-center px-4 py-12">
               <div className="w-full max-w-4xl mx-auto flex flex-col gap-6">
                    ...
                    <div className="bg-gray-900 border border-gray-800 rounded-3xl p-8 md:p-12 flex flex-col gap-6 shadow-xl">
                         <h1 className="text-3xl font-black text-white">ToolLok HTML Sitemap</h1>
                         <p className="text-sm text-gray-400">Complete index of all categories and free browser utilities.</p>
                         ...
                         <div className="flex flex-col gap-6 mt-4">
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                   ...
                                   <Link href="/privacy" className="text-xs text-gray-300 hover:text-white bg-gray-950 p-3 rounded-xl border border-gray-800">Privacy Policy</Link>
                                   <Link href="/terms" className="text-xs text-gray-300 hover:text-white bg-gray-950 p-3 rounded-xl border border-gray-800">Terms & Conditions</Link>
                                   <Link href="/disclaimer" className="text-xs text-gray-300 hover:text-white bg-gray-950 p-3 rounded-xl border border-gray-800">Disclaimer</Link>
                              </div>

                              <h2 className="text-cyan-400 font-bold text-lg border-b border-gray-800 pb-2 mt-4">All Tools Index</h2>
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                   {MASTER_TOOLS_LIST.map((tool) => (
                                        <Link key={tool.id} href={tool.slug} className="text-xs text-gray-300 hover:text-cyan-400 bg-gray-950 p-3.5 rounded-xl border border-gray-800 flex items-center justify-between">
                                             <span>{tool.name}</span>
